...
import org.wit.animarker.databinding.LoginBinding
...
class Login : AppCompatActivity() {
    ...
    public override fun onStart() {
        ...
        loginRegisterViewModel.liveFirebaseUser.observe(this, Observer { firebaseUser -> if (firebaseUser != null)
        startActivity(Intent(this, List::class.java))
        })

        loginRegisterViewModel.firebaseAuthManager.errorStatus.observe(this, Observer { status -> checkStatus(status) })
    }
